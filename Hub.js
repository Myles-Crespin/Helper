...
function setup() {
  ...
  let colors = [color(255,255,255),color(255,255,255),color(255,255,255),color(255,255,255),color(255,255,255),color(255,255,255)]
  for(let i = 0; i<6; i++){
...
class Button{
  constructor(word,url,color,number){
    ...
    this.button.mousePressed(function buttonpress(){window.location.replace(this.url);})
